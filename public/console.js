/***********************************************************************************************************************
 ...
 /*********************************************************************************************************************/
    ...
    const start = () => {
        ...
        console.log(`%cImportant: If you are going to continue, just note: viewing the source of this website is cheating`, 'color:red;')
        console.log(`Would you like to play a game? [Yes/No]`)
    }

    const Yes = () => {
        // console.log(`Let's play a game then. Are you ready?`) For the future
        console.log(`I like you. Sadly, I haven't came up with a good plot for this game, so it remains unfinished.`)
        return console.log(`If you've got a good idea for a plot, let me know on Twitter (@TrevorThalacker) `)
    }
