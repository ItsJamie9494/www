...
export const ContactPage = () => {
    return (
        <>
            ...
            <p>
                I'm not that hard to contact, luckily. It's mostly just a
                question of where to contact me.
            </p>

            <p>
                Do you have an issue or question relating to{' '}
                <span style={{ display: 'inline-block' }}>
                    <Link href={'https://dothq.co'}>Dot HQ or Dot Browser</Link>
                </span>
                ? I have a Dot HQ email address,{' '}
                <span style={{ display: 'inline-block' }}>
                    <Link href={'mailto:trevor@dothq.co'}>trevor@dothq.co</Link>
                </span>
                , or you could just submit feedback through Dot Browser. Which
            ...
            <p>
                ...
                about it, and if it's still maintained, I'll try and help you
                out.
            </p>

            <p>
                I am available on a lot of social media services. The full list
                is as follows:
            </p>
            ...
            <p>
                You could just email me, through this domain. I have a catch-all
                setup, so any email sent to @{config.hostname} will probably
                make it to me. For best results, please try and email me at{' '}
                <span style={{ display: 'inline-block' }}>
